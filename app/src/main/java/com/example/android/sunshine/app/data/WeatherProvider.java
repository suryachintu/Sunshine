...
public class WeatherProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)){
            ...
            default:throw new UnsupportedOperationException("Unsupported exception exceptio in deleting" + uri);
    ...
    public int update(
        ...
        switch (matcher){
            ...
            case WEATHER:{
                rowId = db.update(WeatherContract.WeatherEntry.TABLE_NAME,values,selection,selectionArgs);
                break;
            }
            case LOCATION:{
                rowId = db.update(WeatherContract.LocationEntry.TABLE_NAME,values,selection,selectionArgs);
                break;
            }
